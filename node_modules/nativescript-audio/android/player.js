                ...
                switch (focusChange) {
                    case android.media.AudioManager.AUDIOFOCUS_GAIN:
                        ...
                        if (_this._lastPlayerVolume && _this._lastPlayerVolume >= 10) {
                            _this._player.setVolume(1.0, 1.0);
                        }
                        else if (_this._lastPlayerVolume) {
                            _this._player.setVolume(parseFloat("0." + _this._lastPlayerVolume.toString()), parseFloat("0." + _this._lastPlayerVolume.toString()));
                        }
                        _this.resume();
                        break;
                    ...
                    case android.media.AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK:
                        ...
                        common_1.TNS_Player_Log("this._lastPlayerVolume", _this._lastPlayerVolume);
                        _this._player.setVolume(0.2, 0.2);
                        break;
                }
            }
        });
